...
import { EyeOff, Eye, ShieldX } from "lucide-react";
import { u as useAuth, w as useSettings, L as LANGS, I as Input, a as Button } from "./router-CefM0D5R.js";
...
function LoginPage() {
  ...
  useEffect(() => {
    if (user && !roleChecking) navigate({
      to: "/dashboard"
    });
  }, [user, navigate, roleChecking]);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex bg-background", children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: showRoleDialog, onOpenChange: setShowRoleDialog, children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-md", children: [
      /* @__PURE__ */ jsxs(DialogHeader, { children: [
        ...
        /* @__PURE__ */ jsx(DialogDescription, { className: "text-center pt-1", children: t("mainRoleNotAllowedDesc") })
      ] }),
