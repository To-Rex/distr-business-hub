...
import { Clock, LayoutDashboard, Users, ShoppingCart, ClipboardList, UserCog, Warehouse, Wallet, Factory, Smartphone, Tag, ArrowUpRight, MapPin, Camera, BarChart3, Calendar, Bell, User, Settings, ChevronsRight, ChevronsLeft, X, Menu, Search, Globe, Check, Moon, Sun, LogOut } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import { u as useAuth, A as API, w as useSettings, a as Button, I as Input, L as LANGS } from "./router-CHkxHBR7.js";
import { g as TooltipProvider, D as DropdownMenu, e as DropdownMenuTrigger, a as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, b as DropdownMenuItem, T as Tooltip, h as TooltipTrigger, f as TooltipContent } from "./tooltip-DxSZqTIe.js";
import "sonner";
...
function ServerClock() {
  ...
  useEffect(() => {
    ...
    fetch(API.systemMonitor, {
      ...
      const offset = serverTimeSec - Date.now() / 1e3;
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const now = new Date(Date.now() + serverOffset * 1e3);
      setTime(now.toLocaleTimeString(void 0, { hour: "2-digit", minute: "2-digit" }));
    };
    tick();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs font-medium text-muted-foreground tabular-nums", children: [
...
function AppShell() {
  ...
  const SidebarContent2 = ({ isCompact = false }) => /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
  ...
  return /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs("div", { className: "h-screen flex overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(SidebarContent2, { isCompact: collapsed }),
          /* @__PURE__ */ jsx(
            "button",
            {
    ...
    mobileOpen && /* @__PURE__ */ jsxs("div", { className: "lg:hidden fixed inset-0 z-50", children: [
      ...
      /* @__PURE__ */ jsx(
        "aside",
        {
          ...
          children: /* @__PURE__ */ jsx(SidebarContent2, {})
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(
...
function AppLayout() {
  ...
  if (user.user_type && !ALLOWED_USER_TYPES.includes(user.user_type)) {
    return /* @__PURE__ */ jsx(Navigate, { to: "/no-access" });
  }
