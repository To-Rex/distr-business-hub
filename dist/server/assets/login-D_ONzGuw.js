...
import { w as useSettings, a as Button, I as Input } from "./router-CefM0D5R.js";
import { L as Label } from "./label-tjESP4at.js";
import { P as useAdminAuth, w as fetchProfile } from "./auth-e3kfMlw4.js";
import { D as Dialog, a as DialogContent, d as DialogHeader, e as DialogTitle, b as DialogDescription } from "./dialog-Bhnte_bc.js";
import "sonner";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex bg-background", children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: showRoleDialog, onOpenChange: setShowRoleDialog, children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-md", children: [
      /* @__PURE__ */ jsxs(DialogHeader, { children: [
        ...
        /* @__PURE__ */ jsx(DialogTitle, { className: "text-center", children: t("roleNotAllowed") }),
        /* @__PURE__ */ jsx(DialogDescription, { className: "text-center pt-1", children: t("adminRoleNotAllowedDesc") })
      ] }),
      /* @__PURE__ */ jsx(Button, { onClick: () => setShowRoleDialog(false), className: "w-full", children: t("roleNotAllowedClose") })
    ] }) })
  ] });
}
export {
