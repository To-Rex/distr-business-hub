...
import { w as useSettings, u as useAuth, A as API, P as PageHeader, C as Card, d as CardHeader, e as CardTitle, b as CardContent, I as Input } from "./router-cZ9I3NNJ.js";
import { U as USER_TYPE_LABELS } from "./admin-api-CFYqZiB0.js";
import { MapPin, Truck, User, Users, Store, Layers, Plus, Minus, Crosshair, Minimize2, Maximize2, Search, X, Gauge, Clock, Route, ChevronRight, ChevronLeft, ShoppingCart, Camera, CameraOff, Wallet, Tag, Globe, Megaphone, UserRound, CreditCard, ShoppingBag, Package, DollarSign, Crown, Factory, Handshake, Building2, Briefcase, ShieldCheck, Shield } from "lucide-react";
...
const ROLE_ICONS = {
  USER: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',
  SUPERADMIN: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',
  ADMIN: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>',
  MANAGER: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',
  ...
  VENDOR_AGENT: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></svg>',
  CLIENT: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',
  DEALER: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',
  FACTORY: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 5V8l-7 5V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/></svg>',
  CEO: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7z"/><path d="M3 20h18"/></svg>',
  FINANCIST: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',
  WAREHOUSE: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="m12 3-8 4.5v9L12 21l8-4.5v-9Z"/><path d="M12 12v9"/><path d="M12 12 20 7.5"/><path d="M12 12 4 7.5"/></svg>',
  SALESMAN: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',
  CASHIER: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',
  HR: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>',
  MARKETING: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="m3 11 18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg>',
  EXTERNAL_SELLER: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><circle cx="12" cy="12" r="10"/><line x1="2" x2="22" y1="12" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',
  MERCHANDISER: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M12 2H2v10l9.29 9.29c.94.94 2.48.94 3.42 0l6.58-6.58c.94-.94.94-2.48 0-3.42L12 2Z"/><path d="M7 7h.01"/></svg>'
};
const MAP_STYLES = {
  standard: {
...
function LiveMapPage() {
  ...
  const [blockedUserIds, setBlockedUserIds] = useState(/* @__PURE__ */ new Set());
  ...
  useEffect(() => {
    const onSelectUserFromSearch = (event) => {
      ...
      if (!fullName) return;
      const matchedUser = activeUsers.find((u) => `${u.first_name} ${u.last_name}`.trim().toLowerCase() === fullName);
  ...
  useEffect(() => {
    ...
    const user2 = activeUsers.find((u) => u.id === userId);
  ...
  const RoleIcon = ({
    ...
    switch (role) {
      ...
      case "SUPERADMIN":
        return /* @__PURE__ */ jsx(Shield, { className: "h-4 w-4 text-white" });
      case "ADMIN":
        return /* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-white" });
      case "MANAGER":
        return /* @__PURE__ */ jsx(Briefcase, { className: "h-4 w-4 text-white" });
      case "SUPERVISOR":
      ...
      case "VENDOR_AGENT":
        return /* @__PURE__ */ jsx(ShoppingCart, { className: "h-4 w-4 text-white" });
      case "CLIENT":
        return /* @__PURE__ */ jsx(Building2, { className: "h-4 w-4 text-white" });
      case "DEALER":
        return /* @__PURE__ */ jsx(Handshake, { className: "h-4 w-4 text-white" });
      case "FACTORY":
        return /* @__PURE__ */ jsx(Factory, { className: "h-4 w-4 text-white" });
      case "CEO":
        return /* @__PURE__ */ jsx(Crown, { className: "h-4 w-4 text-white" });
      case "FINANCIST":
        return /* @__PURE__ */ jsx(DollarSign, { className: "h-4 w-4 text-white" });
      case "WAREHOUSE":
        return /* @__PURE__ */ jsx(Package, { className: "h-4 w-4 text-white" });
      case "SALESMAN":
        return /* @__PURE__ */ jsx(ShoppingBag, { className: "h-4 w-4 text-white" });
      case "CASHIER":
        return /* @__PURE__ */ jsx(CreditCard, { className: "h-4 w-4 text-white" });
      case "HR":
        return /* @__PURE__ */ jsx(UserRound, { className: "h-4 w-4 text-white" });
      case "MARKETING":
        return /* @__PURE__ */ jsx(Megaphone, { className: "h-4 w-4 text-white" });
      case "EXTERNAL_SELLER":
        return /* @__PURE__ */ jsx(Globe, { className: "h-4 w-4 text-white" });
      case "MERCHANDISER":
        return /* @__PURE__ */ jsx(Tag, { className: "h-4 w-4 text-white" });
      default:
  ...
  return /* @__PURE__ */ jsxs("div", { className: isFullscreen ? "fixed inset-0 z-[9999]" : "", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: isFullscreen ? "absolute top-3 left-3 z-[1001] bg-card/95 backdrop-blur-sm rounded-lg border shadow-lg p-2.5 flex items-center gap-3 flex-wrap" : "flex items-center gap-3 mb-3 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1.5", children: (() => {
        const primaryRoles = ["SUPERVISOR", "AGENT", "DELIVERER"];
            ...
            return /* @__PURE__ */ jsxs("div", { className: "mt-1 space-y-2.5 rounded-xl border bg-card/80 p-2.5 shadow-sm", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-muted/50 p-2.5 text-center", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "text-sm font-bold leading-tight", children: sessionTime ? /* @__PURE__ */ jsxs(Fragment, { children: [
                    isYesterday && /* @__PURE__ */ jsx("span", { className: "text-[10px] font-normal text-amber-600 mr-1", children: "Kecha" }),
                    sessionTime
