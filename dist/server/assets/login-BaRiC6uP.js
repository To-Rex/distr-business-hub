...
import { u as useAuth, w as useSettings, L as LANGS, I as Input, a as Button } from "./router-CLlTYvOR.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex bg-background", children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: showRoleDialog, onOpenChange: setShowRoleDialog, children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-md", children: [
      /* @__PURE__ */ jsxs(DialogHeader, { children: [
        ...
        /* @__PURE__ */ jsx(DialogDescription, { className: "text-center pt-1", children: "Siz MANAGER, SUPERVISOR yoki CEO roliga ega emassiz. Tizimga faqat ushbu rolli foydalanuvchilar kirishi mumkin." })
      ] }),
