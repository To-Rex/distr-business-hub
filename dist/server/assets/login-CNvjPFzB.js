...
import { ShieldCheck, ExternalLink, EyeOff, Eye, ArrowRight, ShieldX } from "lucide-react";
import { w as useSettings, a as Button, I as Input } from "./router-BPHBZid_.js";
import { L as Label } from "./label--O3xDM7_.js";
import { P as useAdminAuth, w as fetchProfile } from "./auth-Bw5LTJMG.js";
import { D as Dialog, a as DialogContent, d as DialogHeader, e as DialogTitle, b as DialogDescription } from "./dialog-BlgNatLs.js";
import "sonner";
...
function AdminLoginPage() {
  ...
  if (isAuthenticated && !roleChecking) return /* @__PURE__ */ jsx(Navigate, { to: "/admin/users" });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex bg-background", children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: showRoleDialog, onOpenChange: setShowRoleDialog, children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-md", children: [
      /* @__PURE__ */ jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsx("div", { className: "mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-destructive/10 mb-2", children: /* @__PURE__ */ jsx(ShieldX, { className: "h-6 w-6 text-destructive" }) }),
        /* @__PURE__ */ jsx(DialogTitle, { className: "text-center", children: "Ruxsat berilmagan" }),
        /* @__PURE__ */ jsx(DialogDescription, { className: "text-center pt-1", children: "Siz ADMIN yoki SUPERADMIN roliga ega emassiz. Admin panelga faqat ADMIN va SUPERADMIN rolli foydalanuvchilar kirishi mumkin." })
      ] }),
      /* @__PURE__ */ jsx(Button, { onClick: () => setShowRoleDialog(false), className: "w-full", children: "Tushunarli" })
    ] }) })
  ] });
}
export {
