...
import { S as useAdminAuth } from "./auth-BJESO2H6.js";
import { ChevronsRight, ChevronsLeft, X, Menu, Search, Globe, Check, Moon, Sun, Bell, LayoutDashboard, Users, Building2, Smartphone, Monitor, Bot, Settings, LogOut } from "lucide-react";
import { useState, useEffect } from "react";
import { w as useSettings, q as cn, a as Button, I as Input, L as LANGS } from "./router-DPTQhM-i.js";
import { g as TooltipProvider, D as DropdownMenu, e as DropdownMenuTrigger, a as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, b as DropdownMenuItem, T as Tooltip, h as TooltipTrigger, f as TooltipContent } from "./tooltip-BqOq-RcN.js";
function AdminGuard({ children }) {
  ...
  if (profileLoading) {
    return /* @__PURE__ */ jsx("div", { className: "flex h-screen items-center justify-center bg-background", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-4 border-muted border-t-primary" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Yuklanmoqda..." })
    ] }) });
  }
  const userType = session?.user_type;
  if (userType && userType !== "ADMIN" && userType !== "SUPERADMIN") {
    return /* @__PURE__ */ jsx(Navigate, { to: "/admin/no-access" });
  }
...
const NAV_ITEMS = [
  ...
  { to: "/admin/ai-agent", labelKey: "adminAiAgent", icon: Bot },
