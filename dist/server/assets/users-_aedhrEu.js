...
import { q as cn, w as useSettings, v as useIsMobile, I as Input, a as Button, S as Select, h as SelectTrigger, i as SelectValue, f as SelectContent, g as SelectItem, C as Card, b as CardContent, T as Table, n as TableHeader, o as TableRow, m as TableHead, k as TableBody, l as TableCell, B as Badge, d as CardHeader, e as CardTitle } from "./router-cZ9I3NNJ.js";
import { A as AdminGuard, a as AdminLayout } from "./admin-layout-Bm4_9_XI.js";
import { useQueryClient, useQuery, useMutation } from "@tanstack/react-query";
import { D as fetchUsers, w as fetchCompanies, v as fetchBranches, H as getUserStatusLabel, I as getUserTypeLabel, G as getUserFullName, C as fetchUserLocationHistory, o as deleteUser, g as createUser, S as updateUser } from "./admin-api-CFYqZiB0.js";
import { S as Separator } from "./separator-BUUj9iN6.js";
import { D as DropdownMenu, e as DropdownMenuTrigger, a as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, b as DropdownMenuItem } from "./tooltip-kF691cPu.js";
import { D as Dialog, a as DialogContent, d as DialogHeader, e as DialogTitle, b as DialogDescription, c as DialogFooter } from "./dialog-BjrgJ72d.js";
import { L as Label } from "./label-CA5E4i8x.js";
import * as AvatarPrimitive from "@radix-ui/react-avatar";
import { T as Tabs, b as TabsList, c as TabsTrigger } from "./tabs-8cGmox-V.js";
import { A as AlertDialog, c as AlertDialogContent, f as AlertDialogHeader, g as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, b as AlertDialogCancel, a as AlertDialogAction } from "./alert-dialog-C2qyU3GR.js";
...
function AdminUsersPage() {
  ...
  const filteredAndSortedUsers = useMemo(() => {
    ...
    if (searchQuery) {
      ...
      result = result.filter((user) => user.fullName.toLowerCase().includes(query) || user.email.toLowerCase().includes(query) || user.phone.includes(query) || user.role.toLowerCase().includes(query) || user.companyName && user.companyName.toLowerCase().includes(query) || user.branchName && user.branchName.toLowerCase().includes(query));
    }
  ...
  const UserCard = ({
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      ...
      user.branchName && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsx(Users, { className: "h-4 w-4" }),
        /* @__PURE__ */ jsx("span", { children: user.branchName })
      ] }),
  ...
  return /* @__PURE__ */ jsx(AdminGuard, { children: /* @__PURE__ */ jsxs(AdminLayout, { title: t("adminUsers"), subtitle: t("adminUsersSubtitle"), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-4 mb-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-4", children: [
        /* @__PURE__ */ jsxs(Select, { value: companyFilter, onValueChange: (v) => {
          setCompanyFilter(v);
          if (v !== "all" && v !== "no-company") {
            const branchInCompany = apiBranches.some((b) => b.id === Number(branchFilter) && b.company_id === Number(v));
        ...
        /* @__PURE__ */ jsxs(Select, { value: branchFilter, onValueChange: (v) => {
          ...
          /* @__PURE__ */ jsx(SelectTrigger, { className: "w-[180px]", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Filial" }) }),
          /* @__PURE__ */ jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsx(SelectItem, { value: "all", children: "Barcha filiallar" }),
            branchFilterOptions.length > 0 && branchFilterOptions.map((branch) => /* @__PURE__ */ jsx(SelectItem, { value: branch.id.toString(), children: branch.name }, branch.id))
          ] })
        ] }),
    ...
    viewMode === "table" ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
      /* @__PURE__ */ jsxs(Table, { children: [
        /* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableHead, { children: "Filial" }),
        ...
        /* @__PURE__ */ jsx(TableBody, { children: filteredAndSortedUsers.map((user) => /* @__PURE__ */ jsxs(TableRow, { className: "cursor-pointer group", onClick: () => handleView(user), children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: user.branchName || "—" }),
      ...
      selectedUser && (() => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "space-y-5 py-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-3 text-sm", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Filial" }),
              /* @__PURE__ */ jsx("p", { className: "font-medium", children: selectedUser.branchName || "—" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxs(Select, { value: formData.companyId?.toString() || "none", onValueChange: (v) => {
                  if (v === "none") {
                    ...
                    const currentBranch = formData.branchId ? apiBranches.find((b) => b.id === formData.branchId && b.company_id === company?.id) : null;
                    setFormData({
                      ...formData,
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "branch", className: "text-xs font-medium", children: "Filial" }),
                /* @__PURE__ */ jsxs(Select, { value: formData.branchId?.toString() || "none", onValueChange: (v) => {
                  if (v === "none") {
                    setFormData({
                      ...formData,
                      branchId: null,
                  ...
                  /* @__PURE__ */ jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsx(SelectItem, { value: "none", children: "Tanlanmagan" }),
                    filteredBranches.map((branch) => /* @__PURE__ */ jsx(SelectItem, { value: branch.id.toString(), children: branch.name }, branch.id))
                  ] })
                ] })
              ] })
            ] }),
