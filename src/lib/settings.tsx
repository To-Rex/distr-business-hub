...
const dict = {
  uz: {
    ...
    kpiComingSoon:
      "Hozirda ushbu sahifa ustida ish olib borilmoqda. Tez orada bu yerda samaradorlik ko'rsatkichlari (KPI) paydo bo'ladi.",
  ...
  ru: {
    ...
    kpiComingSoon:
      "Данный раздел находится в разработке. Скоро здесь появятся показатели эффективности (KPI).",
    noVisit: "Нет визита",
  ...
  en: {
    ...
    kpiComingSoon:
      "This section is currently under development. KPI indicators will appear here soon.",
    noVisit: "No visit",
